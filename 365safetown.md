...
또한 강원특별자치도소방학교 직원들과 더불어 365세이프타운에 근무하는 모든 직원분들의 태백 시내에서의 한달 소비 경향을 분석하고, 이를 통해 365세이프타운의 정부 예산의 주를 이루는 [근로 소득이 실질적으로 지역 사회로 환류되며, 지역 경제를 활성화 시키는 주요 동인](20251006_annual_economic_impact_of_safetown_employee_local_spending.md) 중의 하나임을 보여주고자 합니다.
...
| `/archive/` | [아카이브](365safetown_archive.md) |
